        ...
        <div className="mx-auto max-w-7xl rounded-[2.75rem] border border-blue-100/80 bg-white px-6 py-16 shadow-[0_22px_70px_rgba(37,99,235,.08)] sm:px-10 sm:py-20 lg:px-14">
          ...
          <div className="relative mx-auto mt-14 max-w-5xl rounded-[2rem] border border-blue-100 bg-white p-6 shadow-[0_24px_70px_rgba(37,99,235,.10)] sm:p-10">
            ...
            <div className="relative grid items-center gap-5 lg:grid-cols-[1fr_auto_1fr]">
              ...
              <div className="relative mx-auto grid h-44 w-44 place-items-center rounded-full border border-blue-200 bg-blue-50 shadow-[0_0_80px_rgba(59,130,246,.18)]"><div className="grid h-28 w-28 place-items-center rounded-[2rem] bg-gradient-to-br from-blue-600 to-indigo-500 shadow-xl"><img src="/brand/logo-icon-square.png" alt="ContactReachout" width="64" height="64" className="h-16 w-16 rounded-2xl object-contain shadow-md" /></div></div>
