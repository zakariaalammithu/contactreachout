    ...
    <div className="mx-auto max-w-4xl space-y-6 pb-16">
      <div><p className="text-sm font-black text-[#0e6de4]">Support</p><h1 className="mt-2 text-3xl font-black text-slate-950">Privacy Policy</h1><p className="mt-3 text-slate-600">How ContactReachout handles account and campaign information.</p></div>
        <section className="space-y-5 rounded-3xl border border-blue-100 bg-white p-7 shadow-sm">
          ...
          <div><h2 className="font-black text-slate-900">Website analytics</h2><p className="mt-2 text-sm leading-7 text-slate-600">The website uses first-party analytics to measure pages viewed, approximate visit duration, traffic source, device/browser category, and country when that information is reliably provided by the hosting environment. Visitor and session identifiers are stored as keyed hashes, not as raw identifiers. Analytics does not intentionally collect passwords, payment details, campaign message content, private lead information, or authentication secrets.</p></div>
