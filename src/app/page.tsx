  ...
  return (
    <div className="min-h-screen bg-[#f4f7ff] text-slate-950">
      ...
      <main className="home-saas-main">
        <section className="relative overflow-hidden bg-[#fafafc] px-4 pb-16 pt-14 sm:px-6 sm:pb-20 sm:pt-16">
          ...
          <div className="relative mx-auto grid max-w-[1440px] items-center gap-12 lg:min-h-[590px] lg:grid-cols-[0.88fr_1.12fr] xl:gap-16">
            ...
            <div className="flex min-w-0 max-w-[610px] flex-col justify-center">
              {/* Top Badge */}
              <div className="inline-flex w-fit items-center gap-2 rounded-full border border-blue-200/90 bg-blue-50/70 px-4 py-1.5 text-xs font-bold text-[#0e6de4] shadow-2xs">
              ...
              <div className="mt-6 flex flex-wrap gap-2.5">
                {[
                  ...
                  <span key={chip} className="inline-flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-50/80 px-3.5 py-1.5 text-xs font-bold text-[#0e6de4]">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#0e6de4]" />
                    {chip}
                  </span>
                ))}
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-center gap-x-7 gap-y-3 text-xs font-bold text-slate-600">
                ...
                <span className="inline-flex items-center gap-2"><BadgeCheck className="h-4 w-4 text-[#0e6de4]" />Controlled submission workflow</span>
              </div>
            </div>
        ...
        <section className="px-4 py-24 sm:px-6"><div className="mx-auto max-w-7xl"><div className="mx-auto max-w-3xl text-center"><p className="text-sm font-black text-[#0e6de4]">Two services. One campaign.</p><h2 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Scale the work, keep the message relevant.</h2><p className="mt-5 text-lg leading-8 text-slate-600">ContactReachout combines bulk contact-form submission with AI-assisted personalization without removing human review and campaign safeguards.</p></div><div className="mt-12 grid gap-6 lg:grid-cols-2"><article className="rounded-[2rem] border border-blue-200 bg-gradient-to-br from-blue-50 to-white p-8 sm:p-10"><div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0e6de4] text-white"><Send className="h-7 w-7" /></div><p className="mt-7 text-xs font-black uppercase tracking-[0.18em] text-[#0e6de4]">Main service 01</p><h3 className="mt-2 text-3xl font-black">Bulk Contact Form Submission</h3><p className="mt-4 leading-7 text-slate-600">Turn named lead lists into structured campaigns that discover contact pages, map messages, respect safeguards, and record every result.</p></article><article className="rounded-[2rem] border border-blue-200 bg-gradient-to-br from-blue-50/50 to-white p-8 sm:p-10"><div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#0e6de4] text-white"><Sparkles className="h-7 w-7" /></div><p className="mt-7 text-xs font-black uppercase tracking-[0.18em] text-[#0e6de4]">Main service 02</p><h3 className="mt-2 text-3xl font-black">AI Personalization</h3><p className="mt-4 leading-7 text-slate-600">Use verified lead context and your campaign guidance to create concise, relevant drafts for review—without inventing company facts.</p></article></div></div></section>

        <section id="control-tower" className="bg-[#f4f7ff] px-4 py-24 sm:px-6"><div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.82fr_1.18fr]"><div><p className="text-sm font-black text-[#0e6de4]">Your Contact Form Submission Tower</p><h2 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">See every campaign move from upload to result.</h2><p className="mt-5 text-lg leading-8 text-slate-600">Keep lead lists, AI drafts, processing status, reviews, and reporting connected in one operational view.</p><div className="mt-7 space-y-3">{['Select a named lead list', 'Guide the AI personalization', 'Control processing and safety', 'Review outcomes and proof'].map((item) => <div key={item} className="flex items-center gap-3 font-bold text-slate-700"><CheckCircle2 className="h-5 w-5 text-[#0e6de4]" />{item}</div>)}</div></div><div className="rounded-[2rem] border border-slate-200/80 bg-white p-4 shadow-2xl shadow-blue-200/40 sm:p-6"><div className="flex flex-wrap items-center gap-3 rounded-2xl bg-slate-50 p-3 text-xs font-bold">{['Lead List', 'AI Draft', 'Review', 'Process', 'Results'].map((item, index) => <div key={item} className="flex items-center gap-3"><span className={`rounded-xl px-3 py-2 ${index === 1 ? 'bg-[#0e6de4] text-white' : 'bg-white text-slate-600 shadow-xs'}`}>{item}</span>{index < 4 && <ArrowRight className="h-4 w-4 text-slate-300" />}</div>)}</div><div className="mt-4 grid gap-4 sm:grid-cols-[0.8fr_1.2fr]"><div className="rounded-2xl border border-slate-100 p-4"><p className="text-xs font-black">Campaign progress</p><div className="mt-5 flex items-center justify-center"><div className="flex h-28 w-28 items-center justify-center rounded-full border-[12px] border-blue-100 border-t-[#0e6de4]"><span className="text-2xl font-black">68%</span></div></div><div className="mt-5 grid grid-cols-2 gap-2 text-center text-[10px] font-bold"><span className="rounded-lg bg-blue-50 p-2 text-[#0e6de4]">1,936 found</span><span className="rounded-lg bg-amber-50 p-2 text-amber-700">42 review</span></div></div><div className="rounded-2xl border border-blue-100 bg-blue-50/50 p-5"><div className="flex items-center gap-2 text-xs font-black text-[#0e6de4]"><MessageSquareText className="h-4 w-4" />AI personalization preview</div><div className="mt-4 rounded-xl bg-white p-4 text-xs leading-6 text-slate-600 shadow-xs"><p className="font-black text-slate-900">Partnership inquiry for Northstar Labs</p><p className="mt-3">Hello Northstar Labs team,</p><p className="mt-2">I came across your work in cloud infrastructure and wanted to reach out about a relevant B2B collaboration.</p><p className="mt-2">Would you be open to a brief conversation?</p></div><div className="mt-3 flex gap-2"><span className="rounded-lg bg-white px-3 py-2 text-[10px] font-black text-[#0e6de4] shadow-2xs">Review draft</span><span className="rounded-lg bg-[#0e6de4] px-3 py-2 text-[10px] font-black text-white">Use in campaign</span></div></div></div></div></div></section>

        <HomeProductSections />

        <section id="features" className="features-section border-y border-blue-100 !bg-white px-4 py-24 sm:px-6"><div className="mx-auto max-w-7xl"><div className="max-w-3xl"><p className="text-sm font-black text-[#0e6de4]">Platform Features</p><h2 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Everything you need, built in.</h2><p className="mt-5 text-lg leading-8 text-slate-600">A complete contact-form outreach platform—from upload and personalization to controlled processing and reporting.</p></div><div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">{platformFeatures.map(({ icon: Icon, title, description }) => <article key={title} className="rounded-3xl border border-slate-200 bg-[#fafaff] p-7 transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-100/50"><Icon className="h-8 w-8 text-[#0e6de4]" /><h3 className="mt-6 text-xl font-black">{title}</h3><p className="mt-3 leading-7 text-slate-600">{description}</p></article>)}</div></div></section>

        <section className="px-4 py-24 sm:px-6"><div className="mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-[#0e6de4] p-8 text-white shadow-2xl shadow-blue-500/20 sm:p-14"><div className="grid items-center gap-10 lg:grid-cols-[1fr_auto]"><div><div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-xs font-black"><Globe2 className="h-4 w-4" />Start free — no credit card required.</div><h2 className="mt-6 text-4xl font-black tracking-tight sm:text-5xl">Ready to automate your contact form outreach?</h2><p className="mt-4 max-w-2xl text-lg leading-8 text-blue-50">Create your account, upload a lead list, personalize your campaign, and keep the entire contact-form submission workflow visible.</p></div><Link href="/signup" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-7 py-4 text-sm font-black text-[#0e6de4] shadow-xl hover:bg-blue-50">Create free account <ArrowRight className="h-4 w-4" /></Link></div></div></section>
      </main>
      <LandingFooter />
    </div>
